						...
						<div className="computer-screen" ref={computerScreenRef}>
							...
							>
								...
								<IconDisplay
									...
									x={0}
									y={3}
									href="https://open.spotify.com/user/31yrdyffpo5wxvcvw2eua6aa4ezm?si=1uIsuapRTvqRV2nQDGeoAA"
								/>
								<IconDisplay
									...
									x={0}
									y={1}
									href="https://www.instagram.com/adri16bit?igsh=eGt0ZXAybWkxcm93"
								/>
								<IconDisplay icon="icons/x.png" title="twitter" x={0} y={2} href="https://twitter.com/adri_16bit" />
								<IconDisplay icon="icons/github.png" title="github" x={0} y={5} href="https://github.com/adri16bit" />
								<IconDisplay icon="icons/steam.png" title="steam" x={0} y={4} href="https://steamcommunity.com/profiles/76561199512414997/" />
